function [train_error] = batch_rbf_impr_squared(train_vect, train_sin, test_vect, test_sin,sigma,units,doPlot)
...
%Make a for loop to go through all test_f to make them 1 or -1.
...
train_error = mean(abs(train_f-train_sin'));
