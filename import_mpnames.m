function mpnames = import_mpnames(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MPNAMES = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   MPNAMES = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   mpnames = importfile('mpnames.txt', 1, 349);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/02/20 17:01:24
