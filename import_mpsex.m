function mpsex = import_mpsex(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MPSEX1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   MPSEX1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   mpsex1 = importfile('mpsex.dat', 2, 350);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/02/20 16:52:05
